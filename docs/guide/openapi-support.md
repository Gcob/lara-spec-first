...
> OpenAPI parser, or registers a route.
...
| `security` (root)                       | Open         | Not yet decided, and the consequence is worth stating: an operation that inherits the document's requirements is indistinguishable, once read, from one with no requirements at all — so removing the root `security` block silently changes what every such operation requires.                                     |
| `webhooks` (3.1)                        | Open         |                                                                                                                                                                                                                                                                                                                      |
