...
covers: >
    ...
    unstable until someone says otherwise, what `stable` costs, the sunset rules
    the doctor enforces, and the RFC 8594 headers the generated code emits.
read_before: >
    Touching the lifecycle extensions, the sunset rules, or breaking-change
    enforcement.
...
OpenAPI can say an operation is deprecated. It cannot say how strong a promise the operation carries
