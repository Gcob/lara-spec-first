...
| Response DTOs            | `spatie/laravel-data`, or only its shape | Undecided   | Its `from($model)` ergonomics are the target. A dependency buys casting, validation and serialisation; it also binds generated code to another package's API and release cycle. Reasoning: [`CODE-GENERATION.md`](./CODE-GENERATION.md#response-dtos).                                                                                                                                                                                                                                                                    |
