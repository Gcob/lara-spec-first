...
final readonly class OperationSelector
{
     ...
     * because [an operation need not have one](../../docs/guide/code-generation/index.md)
     ...
     * [name the commands rather than run them](../../docs/guide/code-generation/index.md#the-build-names-the-command-instead-of-running-it),
